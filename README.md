# library_stringplus
В этом проекте я разрабатывала собственную версию библиотеки string.h на языке программирования Си, включая функции sprintf и sscanf. Библиотека string.h - основная библиотека для работы со строками в языке Си. Целью проекта было закрепление навыков обработки строковых данных и применение структурного подхода.
